...
class Reports_Daily extends StatefulWidget {
  ...
  @override
  _Reports_Daily createState() => _Reports_Daily();
}
                ...
                children: [
                  ...
                  GestureDetector(
                    ...
                    child: Icon(FontAwesomeIcons.arrowLeft,
                        color: color.AppColors.grey, size: 30.0),
                  ),
                ],
              ),
              SizedBox(height: 30),
                  ...
                  Container(
                    ...
                    decoration: BoxDecoration(
                      ...
                      image: DecorationImage(
                        image: AssetImage("assets/images/figure13.png"),
                      ),
                    ),
                  ),
                ],
                  ...
                  child: SfDateRangePicker(
                    ...
                    onSelectionChanged: (DateRangePickerSelectionChangedArgs args) {
                      Navigator.push(
                        context,
                        MaterialPageRoute(
                          builder: (context) => View_Report(selectedDate: args.value),
                        ),
                      );
                    },
                  ),
